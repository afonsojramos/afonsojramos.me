...
Linus Torvalds recently [made a similar distinction from the maintainer's side](https://lore.kernel.org/linux-media/CAHk-=wi4zC+Ze8e+p3tMv8TtG_80KzsZ1syL9anBtmEh5Z40vg@mail.gmail.com/). Linux is not anti-AI; he considers the tool plainly useful. But its use should help maintainers rather than transfer more work onto them. That feels like the right standard. The question is not whether AI touched the code, but whether somebody understood the result, accepted responsibility for it, and left reviewers with something worth reviewing.
