...
const CarouselContent: Component<ComponentProps<"div"> & { parentClass: string }> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  const { carouselRef, orientation } = useCarousel();

  return (
    <div ref={carouselRef} class={cn("overflow-hidden", props.parentClass)}>
      <div
  ...
  return (
    ...
    >
      <svg
        ...
        class={cn("size-4", local.size === "icon" && "size-6")}
        role="img"
